...
class ReportGenerator:
    ...
    def load_data(self):
        ...
        # Water security
        water_csv = self._find_csv('Water', 'Hidrica', 'Seguridad', 'Seguranca')
        if water_csv:
        ...
        # Barriers
        barriers_csv = self._find_csv('Barriers', 'Barreras', 'Barreiras')
        if barriers_csv:
        ...
        # Other challenges
        other_csv = self._find_csv('Other', 'Outros')
        if other_csv:
